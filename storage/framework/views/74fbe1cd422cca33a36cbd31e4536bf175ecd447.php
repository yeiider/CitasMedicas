    ...
    <nav class="navbar navbar-top navbar-horizontal navbar-expand-md navbar-dark">
      <div class="container px-4">
        <a class="navbar-brand" href="../index.html">
          <img src="<?php echo e(asset('public/assets/img/brand/white.png')); ?>" />
        </a>
        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-lg-5 col-md-6">
              <h1 class="text-white">
                  <?php echo $__env->yieldContent('title','Bienvenido'); ?>
             </h1>
                 <p class="text-white"> <?php echo $__env->yieldContent('subtitle'); ?></p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row align-items-center justify-content-xl-between">
        <div class="col-xl-6">
          <div class="copyright text-center text-xl-left text-muted">
            &copy; <?php echo e(date('Y')); ?> <a href="https://www.creative-tim.com" class="font-weight-bold ml-1" target="_blank"><?php echo e(config('app.name')); ?></a>
          </div>
        </div>
        <div class="col-xl-6">
...
<?php /**PATH /var/www/html/CitasMedicas/resources/views/layouts/form.blade.php ENDPATH**/ ?>