        ...
        <div class="card shadow p-3">
            <div class="card-header border-0">
                <div class="row">
                    ...
                    <div class="col">
                    <a href="<?php echo e(url('/patients')); ?>" class="btn btn-default float-right">Cancelar y volver</a>
                    </div>
                </div>
...
unset($__errorArgs, $__bag); ?>" name="address" value="<?php echo e(old('address')); ?>" required placeholder="Direccion">
        ...
        <div class="form-group">
            ...
            <input class="form-control" name="birth" type="date"  id="example-date-input"  value="<?php echo e(old('birth')); ?>">
            </div>
        </div>
        <div class="form-group">
          <div class="input-group input-group-alternative mb-3">
...
<?php echo $__env->make('layouts.panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/CitasMedicas/resources/views/patients/create.blade.php ENDPATH**/ ?>